...
export class User {
  ...
  @OneToMany(() => PetUserItem, (petUserItem) => petUserItem.user)
  pet_user_items: PetUserItem[];

  @OneToMany(() => PetInteraction, (petInteraction) => petInteraction.user)
  ...
  @OneToMany(() => QuestHistory, (questHistory) => questHistory.user)
  quest_history: QuestHistory[];

  @OneToMany(() => ActionHistory, (actionHistory) => actionHistory.user)
  action_history: ActionHistory[];

  @OneToMany(() => QuestSelection, (questSelection) => questSelection.user)
