...
export class QuestHistory {
  ...
  @ManyToOne(() => User, (user) => user.quest_history)
  user: User;

  @ManyToOne(() => Coolpets, (coolPet) => coolPet.quest_history)
  coolpet: Coolpets;

  @ManyToOne(() => QuestTheme, (quest) => quest.quest_history)
  quest: QuestTheme;

  @ManyToOne(() => QuestIo, (io) => io.quest_history)
  io: QuestIo;
